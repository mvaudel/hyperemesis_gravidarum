# Function used to query phenoscanner, copied from its original repository (github.com/phenoscanner/phenoscanner). Licensed GPL-3.0, see original repository for details.
